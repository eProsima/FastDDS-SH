 ...
 *
*/
#ifndef SOSS__DDS__DTPARSER__INTERNAL__DYNAMICTYPEPARSERCOMMON_HPP
#define SOSS__DDS__DTPARSER__INTERNAL__DYNAMICTYPEPARSERCOMMON_HPP
...
#endif //SOSS__DDS__DTPARSER__INTERNAL__DYNAMICTYPEPARSERCOMMON_HPP
